...
$sql = "SELECT `Item_Name`, `Item_des`, `image`, `image2`, `image3`, `image4`, `image5`, `dis`, `rates` FROM `Items` WHERE id = 6;";
...
<head>
    ...
    <link rel="stylesheet" href="assets/css/description_R.css">
...
<body class="category-page">
    ...
    <main id="products">
    <form action="cartR.php" method="POST">
        <div class="container">
          ...
          <div class="producat_content">
            ...
            <div class="qty">
              <div class="btns">
                ...
                <input type="submit" class="add_cart" value="Add to Cart" style="background: #e7f1da;" />
              </div>
            </div>
          </div>
        </div>
