...
$sql = "SELECT `Item_Name`, `Item_des`, `image`, `image2`, `image3`, `image4`, `image5`, `dis`, `rates` FROM `Items` WHERE id = 3;";
          ...
          <div class="producat_content">
            ...
            <div class="qty">
              <div class="btns">
                ...
                <input type="submit" class="add_cart" value="Add to Cart" style="background: #ffeee2;" /></>
              </div>
            </div>
          </div>
        </div>
