...
<img src="assets/image/dr logo 12-01.png" alt="DecoRiz Logo" width="100px" id="logo">
        <nav id="main-nav">
            <a href="homeR.php">Home</a>
            <a href="cartR.php">Cart</a>
            ...
            <span class="right" style="width:120px;">
												<div class="dropdown" style="width:100px;">
													...
													<div class="dropdown-content">
														<a href="proset2.php" style="font-size: medium;">Profile</a>
                                                        <a href="orderh2.php" style="font-size: medium;">Order History</a>
